...
<html lang="en">
	...
	<?php echo form_open('renda_familiar/atualizar', 'codigo_renda_familiar="form-renda_familiar"'); ?>
<h1>RENDA FAMILIAR</h1> 
	<input type="hidden" name="codigo_renda_familiar" value="<?php echo $dados_renda[0]->codigo_renda_familiar; ?>"/>
